...
icer_mat_cost_new <- simulate_ICER_mat(birth_cohort, periods, h, mu_ac, mu_gnr, n_simulations, coverage_mat, efficacy_mat, remaining_years, mat_cost_per_dose, min_cost, max_cost, step_cost)


library("writexl")
write_xlsx(icer_mat_cost_new,"C:/Users/wstil/OneDrive/Desktop/Aim 3/ICER Figure/icer_mat_undisc_new.xlsx", col_name=TRUE, format_headers=FALSE)
